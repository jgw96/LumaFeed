                    ...
                    <div class="empty-state" role="status" aria-live="polite">
                      <div>
                        ...
                        <p class="empty-state-description">
                          Capture nursing or bottle sessions, keep an eye on timing, and know
                          exactly when the next feeding is due.
                        </p>
                      </div>
                      <ul class="empty-state-highlights" aria-label="Benefits of logging feedings">
                        <li class="highlight-item">
                          ...
                          <div>
                            ...
                            <p class="highlight-copy">
                              Use the timer or quick-entry form to record start, end, and feeding
                              amounts in seconds.
                            </p>
                          </div>
                        </li>
                        <li class="highlight-item">
                          ...
                          <div>
                            ...
                            <p class="highlight-copy">
                              We calculate the next feeding window automatically and can remind you
                        ...
                        <li class="highlight-item">
                          ...
                          <div>
                            ...
                            <p class="highlight-copy">
                              Summaries highlight daily totals so you can share updates with
                              caregivers or your pediatrician.
                            </p>
                          </div>
                        </li>
                      </ul>
                      ...
                      <p class="empty-state-footer">
                        You can fine-tune reminders anytime from Settings.
                      </p>
                    </div>
                  `
                : nothing}
